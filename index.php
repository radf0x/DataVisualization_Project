...
<div id="addGoalBoxDiv" style="background-color:black;">
<center>
...
setGoalBox.setBackgroundColor('black');
setGoalBox.setTopBarColor('white');
...
<tr>
<td align="center" width="33%"><a href="javascript:showPowerSearchBox();" style="color:white;">Power Search</a></td>
<td align="center" width="34%"><a href="javascript:showHealthSearchBox();" style="color:white;">Health Search</a></td>
<td align="center" width="33%"><a href="javascript:showPieChartBox();" style="color:white;">Pie Chart</a></td>
</tr>
</table>
<br />
...
refreshHealth();
var powerSearchBox=new PenguinBox(document.body);
powerSearchBox.hide();
powerSearchBox.setBackgroundColor('white');
powerSearchBox.setLightWhenSelected(true);
powerSearchBox.setMoveable(document.body);
powerSearchBox.setSize(90,80);
powerSearchBox.setToCenterMiddle();
powerSearchBox.setContentPageToBox('cli_powersearch.php');
function showPowerSearchBox(){
powerSearchBox.show();
}
var pieBox=new PenguinBox(document.body);
pieBox.hide();
pieBox.setBackgroundColor('rgba(80,80,80,0.5)');
pieBox.setLightWhenSelected(true);
pieBox.setMoveable(document.body);
//pieBox.setSize(90,80);
pieBox.setToCenterMiddle();
function showPieChartBox(){
pieBox.show();
pieBox.setContentPageToBox('chart.php?abc=apples');
}
var healthSearchBox=new PenguinBox(document.body);
healthSearchBox.hide();
healthSearchBox.setBackgroundColor('black');
healthSearchBox.setLightWhenSelected(true);
healthSearchBox.setMoveable(document.body);
healthSearchBox.setSize(96,85);
healthSearchBox.setCloseBtnColor('white');
healthSearchBox.setToCenterMiddle();
healthSearchBox.setContentPageToBox('healthsearch/demo.html');
function showHealthSearchBox(){
healthSearchBox.show();
}
</script>
<? } ?>
...
<? }else{ ?>
<br /><br />
<a href="javascript:showChangeAdminPwBox();" style="color:white;text-decoration:none;">Change Admin Password</a>
<br /><br />
...
var changeAdminPwBox=new PenguinBox(document.body);
changeAdminPwBox.hide();
changeAdminPwBox.setLightWhenSelected(true);
changeAdminPwBox.setBackgroundColor('white');
changeAdminPwBox.setMoveable(document.body);
changeAdminPwBox.setContentPageToBox('cli_changeadminpw.php');
...
function showChangeAdminPwBox(){
changeAdminPwBox.show();
}
</script>
<? } ?>
...
<tr>
<td class="menuBTd" id="menuBTd1" width="20%" align="center" valign="middle"></td>
<td class="menuBTd" id="menuBTd2" width="20%" align="center" valign="middle"></td>
<td class="menuBTd" id="menuBTd3" width="20%" align="center" valign="middle"></td>
<? if($_SESSION[userRole]!='staff'){ ?>
<td class="menuBTd" id="menuBTd4" width="20%" align="center" valign="middle"></td>
<td class="menuBTd" id="menuBTd5" width="20%" align="center" valign="middle"></td>
<? } ?>
</tr>
</table>
...
<? if($_SESSION[userRole]!='staff'){ ?>
var theBoxes=[obj('GoalDiv'),obj('GroupDiv'),obj('HealthDiv'),obj('CompanyDiv'),obj('SettingsDiv')];
var an_left=[[10,110,210,310,410],[-(80+10),10,110,210,310],[-((80+10)*2),-(80+10),10,110,210],[-((80+10)*3),-((80+10)*2),-(80+10),10,110],[-((80+10)*4),-((80+10)*3),-((80+10)*2),-(80+10),10],[-((80+10)*5),-((80+10)*4),-((80+10)*3),-((80+10)*2),-90]];
<? }else{ ?>
var theBoxes=[obj('GroupDiv'),obj('CompanyDiv'),obj('SettingsDiv')];
var an_left=[[10,110,210,310,410],[-(80+10),10,110,210,310],[-((80+10)*2),-(80+10),10,110,210],[-((80+10)*3),-((80+10)*2),-(80+10),10]];
<? } ?>
...
<? if($_SESSION[userRole]!='staff'){ ?>
if (i == 0 )obj('menuBTd'+((i+1))).setAttribute("onClick","goRedraw();an_manager.setAnimationMove(theBoxes[0],an_du,0,'ease',parseInt(theBoxes[0].style.left),parseInt(theBoxes[0].style.top),an_left["+i+"][0],parseInt(theBoxes[0].style.top),'%');an_manager.setAnimationMove(theBoxes[1],an_du,0,'ease',parseInt(theBoxes[1].style.left),parseInt(theBoxes[1].style.top),an_left["+i+"][1],parseInt(theBoxes[1].style.top),'%');an_manager.setAnimationMove(theBoxes[2],an_du,0,'ease',parseInt(theBoxes[2].style.left),parseInt(theBoxes[2].style.top),an_left["+i+"][2],parseInt(theBoxes[2].style.top),'%');an_manager.setAnimationMove(theBoxes[3],an_du,0,'ease',parseInt(theBoxes[3].style.left),parseInt(theBoxes[3].style.top),an_left["+i+"][3],parseInt(theBoxes[3].style.top),'%');an_manager.setAnimationMove(theBoxes[4],an_du,0,'ease',parseInt(theBoxes[4].style.left),parseInt(theBoxes[4].style.top),an_left["+i+"][4],parseInt(theBoxes[4].style.top),'%');");
else obj('menuBTd'+((i+1))).setAttribute("onClick","an_manager.setAnimationMove(theBoxes[0],an_du,0,'ease',parseInt(theBoxes[0].style.left),parseInt(theBoxes[0].style.top),an_left["+i+"][0],parseInt(theBoxes[0].style.top),'%');an_manager.setAnimationMove(theBoxes[1],an_du,0,'ease',parseInt(theBoxes[1].style.left),parseInt(theBoxes[1].style.top),an_left["+i+"][1],parseInt(theBoxes[1].style.top),'%');an_manager.setAnimationMove(theBoxes[2],an_du,0,'ease',parseInt(theBoxes[2].style.left),parseInt(theBoxes[2].style.top),an_left["+i+"][2],parseInt(theBoxes[2].style.top),'%');an_manager.setAnimationMove(theBoxes[3],an_du,0,'ease',parseInt(theBoxes[3].style.left),parseInt(theBoxes[3].style.top),an_left["+i+"][3],parseInt(theBoxes[3].style.top),'%');an_manager.setAnimationMove(theBoxes[4],an_du,0,'ease',parseInt(theBoxes[4].style.left),parseInt(theBoxes[4].style.top),an_left["+i+"][4],parseInt(theBoxes[4].style.top),'%');");
<? }else{ ?>
